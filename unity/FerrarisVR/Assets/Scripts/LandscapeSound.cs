...
namespace Ferraris
{
    ...
    public class LandscapeSound : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            var barn=System.Array.Find(app.Data.buildings,b=>b.kind=="barn");
            Add("Houtwerk op het erf","Schurend en kloppend hout bij een erfgebouw. Een illustratie van handwerk, geen bewijs van een historische werkplaats op deze plek.",new Vector3(barn.x+8,app.Area.Height(barn.x,barn.z)+1,barn.z),"wood",80);
