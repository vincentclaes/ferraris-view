    ...
    public class FerrarisApp : MonoBehaviour
    {
        ...
        void Awake()
        {
            ...
            try
            {
                ...
                Ready=true;ReturnToMap();gameObject.AddComponent<AddressDisplay>();gameObject.AddComponent<HomeSearch>();gameObject.AddComponent<PersonsDay>();StartCoroutine(DetectXR());
