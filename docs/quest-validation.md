...
Latest package: **13 September 2026**, `builds/Winksele1775.apk`, **79,159,291 bytes** (75.49 MiB). SHA-256: `02fff2366f6d92aeb20293d2f021520d12608a3c1446115de8591eab26fd5abf`. Unity 6000.6.0f1 built Android ARM64 with OpenXR, Vulkan, minimum API 29 and target API 36. APK Signature Scheme v2 verifies. The manifest contains VR launch/headtracking declarations and Meta Quest supported-device metadata.
...
Hardware status: ADB found no attached device on 13 September. This package has **not** been installed or tested on the headset. The earlier simple prototype was installed and launched on 12 September; Vincent confirmed map → world → movement → B return, and a short sample reported 72–73 FPS. Those results do not validate the current graphics, polygon colliders or discovery interfaces. The package now contains five illustrative human tableaux and their shared visitor controls; these also need headset validation.
